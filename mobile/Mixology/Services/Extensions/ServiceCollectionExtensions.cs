...
public static class ServiceCollectionExtensions
{
    ...
    public static IServiceCollection AddNotifyApiClient<TService>(this IServiceCollection services, IConfiguration config)
        where TService : class
    {
        services.AddHttpClient<TService>(client =>
        {
            var baseUrl = config["ApiNotifyBaseUrl"];
